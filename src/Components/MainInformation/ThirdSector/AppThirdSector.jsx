    ...
    <div className="third-sector">
      <div className="third-sector-item">
        <div className="third-sector-item-image">
          <img
            src={ThirdSectorImage1}
            className="third-sector-image"
            alt="man feels good"
          />
        </div>
        <div className="third-sector-item-text">
          <div className="third-sector-item-title">
            Индивидуальное финансовое планирование, разработанное специально для
            Вас
          </div>
          <div className="third-sector-item-description">
            Получите индивидуальные стратегии, соответствующие Вашей уникальной
            финансовой ситуации
          </div>
        </div>
      </div>
      <div className="third-sector-item">
        <div className="third-sector-item-image">
          <img
            src={ThirdSectorImage2}
            className="third-sector-image"
            alt="man feels success"
          />
        </div>
        <div className="third-sector-item-text">
          <div className="third-sector-item-title">
      ...
      <div className="third-sector-item">
        <div className="third-sector-item-image">
          <img
            src={ThirdSectorImage3}
            className="third-sector-image"
            alt="man move on his carieer"
          />
        </div>
        <div className="third-sector-item-text">
          <div className="third-sector-item-title">
